...
function Hero() {
  return (
    <section className="bg-[linear-gradient(135deg,oklch(0.91_0.07_25)_0%,oklch(0.97_0.03_25)_50%,oklch(1_0_0)_100%)] pt-0 pb-0 w-full">
      <div style={{ width: "100%", height: "100vh", position: "relative" }}>
        <LiquidEther
          className="p-0 m-0"
          colors={["#ff273d", "#ff9fb8", "#e7e3ea"]}
          mouseForce={20}
          cursorSize={100}
          isViscous
          viscous={30}
      ...
      <div className="flex flex-col items-center justify-center h-full absolute top-0">
        ...
        <div className="flex items-center justify-between gap-12">
          ...
          <div className="relative rounded-2xl h-95 ma-w-xl overflow-hidden">
            <img
